...
echo +==========================================================================+
echo ^| [1] Install Wave (Dependencies + Download + Auto Launch)                 ^|
echo ^| [2] Install Wave (VPS/Server Mode)                                       ^|
echo ^| [3] Install Cloudflare WARP (VPN)                                        ^|
echo ^| [4] Wave Manual Inject (Advanced)                                        ^|
echo ^| [5] Auto Fix Dependencies (.NET + VC++ + Node.js)                        ^|
echo ^| [6] Fix Desktop Path Error (+ Auto Restart)                              ^|
echo ^| [7] (Disabled) Defender Tweaks                                           ^|
